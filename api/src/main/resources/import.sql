...
insert into flights(id, icao_departure, icao_destination, departure_date) values('0c82e974-1447-4b67-b27c-8f55250dac3e', 'KLAX', 'CYVR', '04/12/2023');
insert into flights(id, icao_departure, icao_destination, departure_date) values('f31eabaf-ee9f-4f69-8285-1a02656807a9', 'EPWA', 'KLAX', '10/30/2023');
insert into flights(id, icao_departure, icao_destination, departure_date) values('bfe8c71b-af7e-4985-b3ba-64f36827af69', 'CYVR', 'EPWA', '01/15/2023');
insert into flights(id, icao_departure, icao_destination, departure_date) values('66f3f11f-a6bd-4b43-bfdb-dd842707b13a', 'EDDF', 'EPWA', '02/03/2023');
insert into flights(id, icao_departure, icao_destination, departure_date) values('200be1c1-06dc-40b6-a112-ddc435dc8f50', 'LFPG', 'EPKK', '06/10/2023');
